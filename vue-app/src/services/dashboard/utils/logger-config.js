/**
 * Конфигурация уровней логирования для дашбордов секторов
 *
 * Управляет уровнями логирования через localStorage
 * для всех сервисов дашбордов секторов (1C, PDM, Bitrix24, Infrastructure)
 *
 * Использование:
...
const STORAGE_KEY = 'dashboard-sectors-logger-level';
