...
- [x] Плавающая кнопка "НАЗАД" добавлена в компонент дашборда
- [x] Кнопка отображается только на мобильной версии (< 768px)
- [x] Кнопка скрыта на планшете и десктопе (≥ 768px)
- [x] Кнопка закреплена на уровне скролла (fixed position)
- [x] Кнопка имеет небольшой, но заметный размер
- [x] Кнопка имеет привлекательный дизайн (тень, цвет, форма)
- [x] При клике на кнопку происходит переход на стартовую страницу (`/`)
- [x] Кнопка видна при любом уровне скролла страницы
- [x] Кнопка имеет hover-эффект и визуальную обратную связь
- [x] Кнопка доступна для навигации с клавиатуры (accessibility)
- [x] Кнопка имеет aria-label для screen readers
...
- **2025-12-06 17:14 (UTC+3, Брест):** Задача успешно выполнена. Реализована плавающая кнопка "НАЗАД" для мобильной версии:
  - Использован метод `goBack()` из TASK-009-01 для навигации
  - Кнопка отображается только на мобильной версии (< 768px)
  - Реализовано фиксированное позиционирование (fixed position)
  - Круглая форма, акцентный цвет Bitrix24 (#2196F3)
  - Добавлены тень и эффект "плавания"
  - Реализованы hover-эффекты и анимации
  - Обеспечена доступность (aria-label, title, клавиатурная навигация)
