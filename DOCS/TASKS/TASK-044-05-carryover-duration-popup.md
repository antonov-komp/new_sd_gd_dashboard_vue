...
- Отобразить список из 5 категорий сроков с количеством тикетов
...
- [ ] При клике на «Переходящие» открывается `CarryoverDurationModal`
- [ ] В попапе отображается градация «По срокам» с 5 категориями:
  - [ ] Менее 1 месяца
  - [ ] Более 1 месяца
  - [ ] Более 2 месяцев
  - [ ] Более полугода
  - [ ] Более года
- [ ] Каждая категория отображается с количеством тикетов
...
- [ ] Заголовок попапа обновляется: «Тикеты: [Название категории]»
...
- [ ] Визуальное оформление соответствует `StagesModal` и `ResponsibleModal`
- [ ] Цвета категорий соответствуют градиенту (от зелёного к красному)
...
**Все категории должны отображаться, даже если count = 0:**
- Менее 1 месяца — зелёный `#28a745`
- Более 1 месяца — жёлтый `#ffc107`
- Более 2 месяцев — оранжевый `#ff9800`
- Более полугода — красный `#dc3545`
- Более года — тёмно-красный `#c82333`
