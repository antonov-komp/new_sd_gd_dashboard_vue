...
- 2025-12-06 10:04 (UTC+3, Брест): Задача завершена. Исправлена логика отображения имени пользователя (NAME + LAST_NAME). Обновлён заголовок приветствия на "Страница Аналитики ИТ отдела для Планерки Генеральной дирекции"
