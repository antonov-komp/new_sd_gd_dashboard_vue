...
- [ ] `WebhookLogFilters.vue` обновлён для работы с типизированными фильтрами
- [ ] `WebhookLogSearch.vue` адаптирован для поиска по новой структуре данных
- [ ] `WebhookLogsStats.vue` обновлён для работы с новой структурой данных
- [ ] `WebhookLogsDashboard.vue` обновлён для отображения улучшенной статистики
- [ ] `WebhookLogsExport.vue` адаптирован для экспорта новых форматов данных
- [ ] `RealtimeControls.vue` обновлён для работы с обновлённым `useRealtime`
- [ ] `NewLogsIndicator.vue` обновлён для отображения валидированных новых логов
