...
- `DT140_12:SUCCESS` — Успешно закрыто (закрывающая)
- `DT140_12:FAIL` — Закрыто с ошибкой (закрывающая)
- `DT140_12:UC_0GBU8Z` — Закрыто (закрывающая)
...
$allStages = [
    ...
    'DT140_12:SUCCESS' => ['name' => 'Успешно закрыто', 'color' => '#28a745'],
    'DT140_12:FAIL' => ['name' => 'Закрыто с ошибкой', 'color' => '#dc3545'],
    'DT140_12:UC_0GBU8Z' => ['name' => 'Закрыто', 'color' => '#6c757d']
];
