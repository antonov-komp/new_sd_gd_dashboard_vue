...
- [x] Кнопка "Главная" присутствует в DashboardSector1C
- [x] Кнопка "Главная" присутствует в GraphStateDashboard
- [x] Кнопка "Главная" присутствует в GraphAdmissionClosureDashboard
- [x] Кнопка "Главная" присутствует в TicketsTimeTrackingDashboard
- [x] При клике на кнопку происходит переход на главную страницу
- [x] Кнопка корректно отображается на всех устройствах

### Технические критерии:
- [x] Код соответствует стандартам Vue.js
- [x] Нет ошибок в консоли браузера
- [x] Время загрузки дашбордов не увеличилось
- [x] Код прошел линтинг (ESLint)

### Критерии качества:
- [x] Код читаемый и документированный
- [x] Реализация консистентна во всех дашбордах
- [x] Отсутствуют дублирования кода
- [x] Компоненты остаются модульными
...
| 2026-01-10 13:30 | Bitrix24 Vue.js Разработчик | Задача взята в работу |
| 2026-01-10 15:00 | Bitrix24 Vue.js Разработчик | Реализация завершена |
