...
- [x] Кнопка "НАЗАД" добавлена в заголовок дашборда
- [x] Кнопка отображается на десктопной версии (> 1024px)
- [x] Кнопка отображается на планшетной версии (768px - 1024px)
- [x] Кнопка скрыта на мобильной версии (< 768px) или видна (на усмотрение)
- [x] При клике на кнопку происходит переход на стартовую страницу (`/`)
- [x] Кнопка работает во всех состояниях компонента (загрузка, ошибка, контент)
- [x] Стили кнопки соответствуют гайдлайнам Bitrix24 UI
...
- **2025-12-06 17:14 (UTC+3, Брест):** Задача успешно выполнена. Реализована кнопка "НАЗАД" в заголовке дашборда:
  - Добавлен метод `goBack()` для навигации на стартовую страницу
  - Кнопка отображается на десктопе и планшете, скрыта на мобильной версии
  - Реализованы стили в соответствии с гайдлайнами Bitrix24 UI
  - Добавлены hover-эффекты и визуальная обратная связь
  - Обеспечена доступность (aria-label, клавиатурная навигация)
