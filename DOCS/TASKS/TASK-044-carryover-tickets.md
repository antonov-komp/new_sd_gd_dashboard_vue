...
1. **До 1 месяца:**
   ...
   - Пример: тикет создан 2025-11-25, период начинается 2025-12-08 → срок = 13 дней
...
**Предложение (6 категорий):**
- До 1 месяца (0-13 дней): зелёный `#28a745` (свежие тикеты)
- Менее 1 месяца (14-29 дней): светло-зелёный `#6cbd45` (нормальные тикеты)
- Более 1 месяца (30-59 дней): жёлтый `#ffc107` (требуют внимания)
- Более 2 месяцев (60-179 дней): оранжевый `#ff9800` (критично)
- Более полугода (180-364 дня): красный `#dc3545` (очень критично)
- Более года (≥365 дней): тёмно-красный `#c82333` (максимально критично)
...
- 2025-12-16 18:50 (UTC+3, Брест): Добавлена 6-я категория «До 1 месяца»
  ...
  - Обновлена документация для отражения 6 категорий
