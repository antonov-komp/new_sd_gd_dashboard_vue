...
## Критерии приёмки
- [ ] fetchTicketsForMonths() реализован
- [ ] fetchCarryoverTicketsForMonths() реализован
- [ ] Параллельные запросы работают корректно
- [ ] Fallback на последовательные запросы работает при ошибках
- [ ] Пагинация работает для всех запросов
- [ ] Фильтрация по product=1C работает
