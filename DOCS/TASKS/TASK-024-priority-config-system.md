# TASK-024: Система конфигурации приоритетов на основе UF_CRM_7_UF_PRIORITY
...
- 2025-12-11 18:00 (UTC+3, Брест): Создана задача TASK-024 с планом реализации из 5 этапов
...
- `TASK-024-01-priority-config-creation.md` — Этап 1
- `TASK-024-02-ticket-mapper-update.md` — Этап 2
- `TASK-024-03-ticket-card-update.md` — Этап 3
- `TASK-024-04-unidentified-priority-handling.md` — Этап 4
- `TASK-024-05-testing-and-integration.md` — Этап 5
