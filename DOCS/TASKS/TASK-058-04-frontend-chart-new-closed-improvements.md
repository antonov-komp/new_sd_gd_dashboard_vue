...
- **Важно:** На графике отображаются только 3 месяца (текущий + 2 предыдущих): Октябрь, Ноябрь, Декабрь
- **Важно:** 4-й месяц (Сентябрь) не отображается на графике, но его данные используются для расчета процентов в сводном итоге
