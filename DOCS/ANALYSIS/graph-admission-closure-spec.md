...
**Статус рефакторинга:** 
- ✅ Недельный режим (`periodMode=weeks`) перенесён в новый модуль (2025-12-23)
- ✅ Месячный режим (`periodMode=months`) перенесён в новый модуль (2025-12-23)
- ✅ Legacy файл стал тонким прокси для обратной совместимости
